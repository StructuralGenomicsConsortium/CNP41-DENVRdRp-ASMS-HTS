# CNP41-DENVRdRp-ASMS-HTS
An [SGC](https://www.thesgc.org/) Open Chemical Networks Project (number 41) devoted to the dengue virus (DENV) RdRp, focusing specifically on exploring possible lead compounds from an ASMS HTS performed at SGC in Toronto. 

* **For the science background**, head to the [wiki](https://github.com/StructuralGenomicsConsortium/CNP41-DENVRdRp-ASMS-HTS/wiki) to check out the living paper that is being written there.
...
**Please see the full [list](https://github.com/StructuralGenomicsConsortium/CNP41-DENVRdRp-ASMS-HTS/wiki/Researchers-involved) for more details**   
